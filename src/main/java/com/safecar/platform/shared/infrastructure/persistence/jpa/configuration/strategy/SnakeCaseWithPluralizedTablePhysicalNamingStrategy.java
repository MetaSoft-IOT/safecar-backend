package com.safecar.platform.shared.infrastructure.persistence.jpa.configuration.strategy;
...
/**
 * A PhysicalNamingStrategy that converts entity names to snake_case and pluralizes table names.
 * 
 * <p>
 * This strategy ensures that all database identifiers (catalogs, schemas, tables, sequences, and columns)
 * are converted to snake_case format. Additionally, table names are pluralized to follow common database
 * naming conventions.
 * </p>
 * 
 * <p>
 * Example: An entity named "UserAccount" will be mapped to a table named "user_accounts".
 * </p>
 * 
 * @version 1.0
 * @since 2025
