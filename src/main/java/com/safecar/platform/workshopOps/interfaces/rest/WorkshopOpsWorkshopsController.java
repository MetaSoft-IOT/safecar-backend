...
public class WorkshopOpsWorkshopsController {
    ...
    public ResponseEntity<Object> getById(@PathVariable Long workshopId) {
        var workshop = new com.safecar.platform.workshopOps.domain.model.valueobjects.WorkshopId(workshopId, "Workshop " + workshopId);
        ...
        var result = new com.safecar.platform.workshopOps.interfaces.rest.resources.WorkshopResource(
