...
import com.safecar.platform.workshopOps.domain.services.VehicleTelemetryQueryService;
import com.safecar.platform.workshopOps.interfaces.rest.resources.TelemetryRecordResource;
import com.safecar.platform.workshopOps.interfaces.rest.transform.TelemetryRecordResourceFromEntityAssembler;
...
public class WorkshopOpsTelemetryController {
    ...
    public ResponseEntity<List<TelemetryRecordResource>> getByVehicleAndRange(@RequestParam Long vehicleId,
        ...
        var vehicle = new com.safecar.platform.workshopOps.domain.model.valueobjects.VehicleId(vehicleId, plateNumber);
    ...
    public ResponseEntity<List<TelemetryRecordResource>> getAlertsBySeverity(
            @RequestParam com.safecar.platform.workshopOps.domain.model.valueobjects.AlertSeverity severity,
